            ...
            >
              ...
              <div v-if="room === 2">
                ...
                >
                  ...
                  <a-collapse-panel header="Quad 1" key="1">
                    <a-row :gutter="16">
                      <a-col :span="8">
                  ...
                  <a-collapse-panel header="Triple 1" key="2">
                    <a-row :gutter="16">
                      <a-col :span="8">
                        <a-form-item label="Title">
                          <a-select
                  ...
                  <a-collapse-panel header="Double 1" key="3">
                    <a-row :gutter="16">
                      <a-col :span="8">
                        <a-form-item label="Title">
                          <a-select
                ...
                <a-card class="b-solid b-radius mb-16">
                  ...
                  <div v-if="checkedFlight">
                    ...
                    <a-comment>
                      ...
                      />
                      <div slot="content">
                        <a-form-item label="Sapa Umaroh Anda" help="Berikan keterangan tentang kedatangan anda">
  ...
  data() {
    return {
      ...
      information: [
        ...
        {
          title:
            "Triple : Room Triple atau sekamar 3 (empat) orang di isi dengan sesama gender"
        },
        {
          title:
            "Double : Room Double atau sekamar 2 (empat) orang di isi dengan sesama gender"
        }
      ]
    };
  },
