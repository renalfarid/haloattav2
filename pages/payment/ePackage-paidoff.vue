            ...
            >
              <a-col :span="12">
                <a-card :bordered="false">
                  <div>
                    <div class="fs-40 fw-500 f-default cr-primary">Alhamdulillah!</div>
                    <div class="fs-18 fw-400 f-default cr-black">
                  ...
                  <div class="mt-24 mb-24">
                    <div class="fs-16 fw-500 cr-primary">Lunas</div>
                    <div class="fs-18 fw-500 cr-black">Rp. 930.000.731</div>
                  </div>
                  <div class="mb-16">
                    <a-button class="ant-btn--action mb-16"><a-icon type="schedule" /> E-Paket telah Terbit</a-button>
