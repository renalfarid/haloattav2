<template>
  <div>
        ...
        <div class="content-head--body">
          ...
          <a-row :gutter="90" class="w-100 m-auto" type="flex" justify="space-around" align="middle">
            <a-col :xs="24" :sm="24" :md="12" :lg="10">
              <h2 class="title fs-40">Ragam Pilihan Perlengkapan Umrah</h2>
    ...
    <div class="content-about--equipment pt-40 pb-40">
      <div class="container">
        <a-divider orientation="left" class="ant-divider-title-left">Tentang Perlengkapan</a-divider>
    ...
    <div class="content-slide--equipment pb-40 pt-40">
      <div class="container">
        <div class="container-slick">
          <a-divider orientation="left" class="ant-divider-title-left">Tips memilih perlengkapan</a-divider>
    ...
    <div class="content-partner--equipment pb-40 pt-40">
      <div class="container">
        <a-divider orientation="left" class="ant-divider-title-left">Partner Perlengkapan</a-divider>
        <a-row>
          <a-col :span="16">
            <p class="fs-16 cr-black">
              It’s an audacious, incredibly rewarding mission that our
    ...
    <div class="content-recommended--equipment pt-40 pb-40">
      <div class="container">
...
export default {
  ...
  head() {
    return {
      title: "Pesan Perlengkapan Umrah - Best Travel Agen | Haloatta"
    };
  },
  data() {
    return {
