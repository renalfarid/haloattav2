<template>
  <div>
    <div class="content-head content-head--insurance">
      <div class="content-head--cover" v-lazy:background-image="require('~/static/asuransi/cover/ac1.png')">
        <div class="content-head--body">
          ...
          <a-row :gutter="90" class="w-100 m-auto" type="flex" justify="space-around" align="middle">
            <a-col :xs="24" :sm="24" :md="12" :lg="10">
              <h2 class="title fs-40">Ragam Pilihan Asuransi Perjalanan</h2>
    ...
    <div class="content-about--insurance pt-40 pb-40">
      <div class="container">
        <a-divider orientation="left" class="ant-divider-title-left">Tentang Asuransi</a-divider>
        <a-row :gutter="24" type="flex" justify="space-between" align="middle">
          ...
          <a-col :span="12">
            <img
              ...
              v-lazy="'/asuransi/ilustrasi/ai1.png'"
            />
          </a-col>
        </a-row>
      </div>
    ...
    <div class="content-slide--insurance pb-40 pt-40">
      <div class="container">
        <div class="container-slick">
          <a-divider orientation="left" class="ant-divider-title-left">Tips memilih Asuransi</a-divider>
              ...
              <a-row :gutter="24" type="flex" justify="space-between" align="middle">
                <a-col :span="12">
                  <img
                    class="mx-width d-block m-auto"
                    style="maxHeight: 320px"
                    v-lazy="'/asuransi/ilustrasi/ai2.png'"
                  />
                </a-col>
                <a-col :span="12">
    ...
    <div class="content-cover--insurance">
      <div
        class="content-cover--images" v-lazy:background-image="require('~/static/asuransi/cover/ac2.png')"
      ></div>
    </div>

    <div class="content-partner--insurance pb-40 pt-40">
      <div class="container">
        <a-divider orientation="left" class="ant-divider-title-left">Partner Asuransi</a-divider>
        <a-row>
          <a-col :span="16">
            <p class="fs-16 cr-black">
              It’s an audacious, incredibly rewarding mission that our
    ...
    <div class="content-recommended--insurance pt-40 pb-40">
      <div class="container">
