<template>
  <div class="ant-transaction--purchase">
    ...
    <a-card :bordered="false" class="ant-card--filter b-radius mt-16 mb-16">
      <a-row :gutter="16" type="flex" justify="space-around" align="middle">
        <a-col
          ...
          :md="24"
          :lg="4"
          class="text-uppercase cr-gray fs-14 mt-4 mb-4"
          >Filter Pembelian</a-col
        >
        <a-col :xs="24" :sm="12" :md="12" :lg="10" class="mt-4 mb-4">
          <a-select
            @change="onChangeProduk"
            showSearch
            defaultValue
            style="width: 100%"
          >
            ...
            <a-select-option value="Land Arrangement"
              >LA Akomodasi</a-select-option
            >
            <a-select-option value="Visa">Visa</a-select-option>
            <a-select-option value="Asuransi">Asuransi</a-select-option>
            <a-select-option value="Handling Domestik"
              >Handling</a-select-option
            >
        ...
        <a-col :xs="24" :sm="12" :md="12" :lg="10" class="mt-4 mb-4">
          <a-select @change="onChangeStatus" defaultValue style="width: 100%">
            ...
            <a-select-option value="Menunggu Approval"
              >Menunggu Approval</a-select-option
            >
            <a-select-option value="Menunggu Pembayaran"
              >Menunggu Pembayaran</a-select-option
            >
            ...
            >
              ...
              <a-col :span="6">
                ...
                <div
                  ...
                  v-if="
                    item.status_bayar === 'Menunggu Approval' ||
                      item.status_bayar === 'Approve'
                  "
                >
                  <span>{{ item.status_bayar }}</span>
                </div>
              ...
              <a-col :span="6">
                <div class="d-flex align-items-center align-end">
                  ...
                  <div
                    v-if="
                      item.status_bayar === 'Menunggu Pembayaran' ||
                        item.status_bayar === 'Approve'
                    "
                  >
                    ...
                    <nuxt-link
                      :to="
                        '/payment/purchase-transfer?notrans=' +
                          item.nomor_transaksi
                      "
