<template>
  <div class="ant-product--wishlist">
    <Empty
      v-if="!lisData.length"
      :transaction="true"
      :label="'Anda tidak memiliki Daftar Simpan'"
    />

    <div v-else>
      <div class="fs-18 fw-500 cr-black">Daftar Simpan</div>
      <div class="fs-16 fw-400 cr-gray">
        Setiap ide layak disimpan! Kami bisa membantu Anda mengingat item yang
        Anda suka.
      </div>

      <a-card
        :bordered="false"
        class="ant-card--filter b-solid b-radius b-shadow mt-16 mb-24"
      >
        <a-row :gutter="16" type="flex" justify="space-around" align="middle">
          ...
          <a-col :span="7">
            ...
            >
              ...
              <a-select-option value="Perlengkapan"
                >Perlengkapan</a-select-option
              >
      ...
      >
        <a-list-item slot="renderItem" slot-scope="item, index" :key="index">
          <a-card class="ant-card-package">
            ...
            <nuxt-link
              :to="
                '/catalog/ticket-group/detail-ticket?kode_produk=' +
                  item.kode_produk
              "
              class="ant-list-item--link"
            ...
            <div slot="cover">
              ...
              >
                ...
                <div
                  class="ant-card--overlay-block"
                  v-if="item.status === 'available'"
                >
                  <div class="d-flex align-items-center h-100">
                    <a-button>
                      <nuxt-link to="/catalog/umrah/detail-package"
                ...
                <div class="ant-card--overlay-block" v-if="item.status === 'Y'">
                  <div class="d-flex align-items-center h-100">
                    <a-button @click="showDeleteConfirm(item.kode_produk)"
                      >Hapus</a-button
                    >
                  </div>
                </div>
