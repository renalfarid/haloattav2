          ...
          <div class="w-100">
            ...
            >
              ...
              <a-col :span="8" class="text-right">
                ...
                <div class="fs-14 fw-500 cr-green" v-if="item.purchase_status === 'Lunas'">
                  <span>{{item.purchase_status}}</span>
                </div>
              </a-col>
            </a-row>
            ...
            <a-row :gutter="16" type="flex" justify="space-between" align="middle" class="m-0 p-16">
              ...
              <a-col :span="8">
                ...
                <div v-if="item.purchase_status === 'Kedaluwarsa'"></div>
                <div v-if="item.purchase_status === 'Lunas'">
                  <div class="fs-14 fw-400 cr-gray">Tanggal Pembayaran</div>
                  <div class="fs-14 fw-500 cr-black">{{item.payment_date}}</div>
                </div>
              </a-col>
              <a-col :span="8">
                <div class="d-flex align-items-center align-end">
                  ...
                  <div v-if="item.purchase_status === 'Kedaluwarsa'">
                    <a-divider type="vertical" />
                    <nuxt-link to="/" class="cr-red fs-14">Pesan Kembali</nuxt-link>
                  </div>
                </div>
              </a-col>
            </a-row>
...
const dataPembelian = [
  ...
  },
  {
    ...
    number_purchase: "20",
    order_date: "14 September 2019",
    payment_date: "10 September 2019",
    payment_limit: "16 September 2019",
    purchase_status: "Lunas",
