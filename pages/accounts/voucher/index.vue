<template>
  <div class="ant-card--voucher">
    <Empty :voucher="true" :label="'Anda tidak memiliki voucher'" v-if="!vouchers.length" />

    <div v-else>
      <div class="fs-18 fw-500 cr-black mb-24">Voucher Saya</div>

      <a-row :gutter="16">
        <a-col :span="12" v-for="(voucher, index) in vouchers" :key="index">
          <a-card :bordered="false" class="mb-16">
            <div class="card-voucher">
              ...
              >
                <div class="m-auto text-center">
                  ...
                  <div class="mt-8 mb-8 item-middle d-flex align-items-center">
                    <img
                      class="m-auto"
                      src="/icons/search/tabs/black/umrah.svg"
                    />
                  </div>
              ...
              <div
                class="card-voucher--item card-voucher--item-color"
                style="width: 60%"
              >
                <div class="voucher-code">
                  <div class="fs-14 text-uppercase p-relative zIndex">
                    <span class="fs-12 mr-4">kode voucher</span>
                    {{ voucher.no_voucher }}
                  </div>
                </div>
