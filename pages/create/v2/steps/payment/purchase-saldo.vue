<template>
  <a-layout class="ant-layout--payment">
    <a-layout-header class="ant-layout-header--payment">
      ...
      <a-steps :current="1" size="small" :style="{ maxWidth: '400px' }">
        <a-step title="Review Pesanan" />
      ...
      <div class="container">
        <a-spin :spinning="spinning" tip="Loading...">
          <a-row type="flex" justify="space-around" align="middle">
            <a-col :xs="24" :sm="22" :md="20" :lg="16" :xl="16" :xxl="16">
                            ...
                            <a-col :span="8">
                              <a-form-item>
                                <a-button
                                  ...
                                  size="large"
                                  block
                                ><nuxt-link to="/accounts/top-up">Top Up Saldo</nuxt-link></a-button>
                              </a-form-item>
                            </a-col>
                          </a-row>
                        </a-form>
...
export default {
  ...
  methods: {
    ...
    nextPurchaseSaldo() {
      this.$router.push("/create/v2/steps/payment/purchase-saldo");
    },
    nextPurchaseTransfer() {
      this.$router.push("/create/v2/steps/payment/purchase-transfer");
    },
    nextEpackagePaidOff() {
      this.$router.push("/create/v2/steps/payment/e-package-success");
    },
    nextEpackageFailed() {
      this.$router.push("/create/v2/steps/payment/e-package-success");
    }
