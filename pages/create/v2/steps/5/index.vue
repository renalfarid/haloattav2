                              ...
                              <a-row :gutter="8">
                                <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                  <a-radio-button :value="1" class="b-shadow">
                                    ...
                                    <div class="fs-14 fw-400 cr-gray f-default text-ellipsis mb-4">Adira Insurance</div>
                                ...
                                <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                  <a-radio-button :value="2" class="b-shadow">
                                    <a-icon type="check-circle" theme="filled" />
                                    <div class="fs-14 fw-400 cr-gray f-default text-ellipsis mb-4">AXA Insurance</div>
                                    <div class="fs-16 fw-500 cr-black">
                                      Rp180.000
                                      <span class="fw-400 cr-gray">/pax</span>
                                    </div>
                                ...
                                <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                  <a-radio-button :value="3" class="b-shadow">
                                    <a-icon type="check-circle" theme="filled" />
                                    <div class="fs-14 fw-400 cr-gray f-default text-ellipsis mb-4">Amanah Insurance</div>
                                    <div class="fs-16 fw-500 cr-black">
                                      Rp240.000
                                      <span class="fw-400 cr-gray">/pax</span>
                                    </div>
