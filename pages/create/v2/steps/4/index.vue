      ...
      <div class="ant-header-item">
        <a-row type="flex" justify="space-between" align="middle">
          ...
          <a-col :span="8">
            ...
            >Langkah 1 Komponen Wajib : Visa Perjalanan</div>
          </a-col>
          <a-col :span="8"></a-col>
        </a-row>
      </div>
          ...
          <a-row type="flex" justify="space-around" align="middle" class="vh-100">
            <a-col :xs="24" :sm="24" :md="22" :lg="20" :xl="18" :xxl="18" class="vh-100">
              <a-row :gutter="24" type="flex" justify="space-between" align="middle" class="vh-100">
                  ...
                  >
                    <div>
                      ...
                      <a-row :gutter="16" type="flex" justify="space-between" align="bottom">
                        ...
                        <a-col :span="24">
                          <a-form-item>Durasi visa anda sesuai program hari</a-form-item>
                        </a-col>
                      </a-row>
                ...
                <a-col :span="11">
                  <img class="max-width d-block ml-auto" src="/steps/visa.svg" />
                </a-col>
              </a-row>
            </a-col>
          </a-row>
...
export default {
  ...
  head() {
    return {
      title: "Pilih Visa Perjalanan - Buat Paket Umrah | Haloatta"
    };
  },
  data() {
    return {
