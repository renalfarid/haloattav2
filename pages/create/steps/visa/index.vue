  ...
  <a-layout :style="{ maxWidth: '1200px', margin: '0 auto' }">
    ...
    <a-layout :style="{ marginLeft: '280px', padding: '24px' }">
      <a-layout-content class="ant-layout-content--steps">
        <div class="fs-20 fw-500 cr-black f-default">Pilih Visa Umrah</div>
              ...
              <a-card slot="overlay">
                <div class="ant-filter-dropdown--overlay">
                  <a-radio-group name="harga">
                    ...
                    <a-radio :style="radioStyle" :value="3">Medinah (MED)</a-radio>
                  </a-radio-group>
                </div>
              </a-card>
            </a-dropdown>
            ...
            <a-dropdown :trigger="['click']">
              ...
              <a-card slot="overlay">
                <div class="ant-filter-dropdown--overlay">
                  <a-radio-group name="harga">
                    <a-radio :style="radioStyle" :value="1">Tampilkan Semua</a-radio>
                    <a-radio :style="radioStyle" :value="2">Visa Kunjungan Wisata/ Visa Turis</a-radio>
                    <a-radio :style="radioStyle" :value="3">Visa on Arrival</a-radio>
                    <a-radio :style="radioStyle" :value="4">Visa Kunjungan Bisnis</a-radio>
                    <a-radio :style="radioStyle" :value="5">Visa Kunjungan Keluarga</a-radio>
                  </a-radio-group>
                </div>
              </a-card>
            </a-dropdown>
        ...
        >
          <a-list-item slot="renderItem" slot-scope="item, index" :key="index">
            <a-skeleton :loading="loading" active>
              <a
                v-on:click="selectedvisa = item.key"
                v-bind:class="[ selectedvisa === item.key ? 'package-selected' : '' ]"
              >
                ...
                <a-card class="ant-card-package">
                  ...
                  >
                    <a-col :span="24" class="text-left">
                      <div class="fs-16 fw-500 cr-black text-capitalize f-default">Visa Umrah</div>
                      <div
...
export default {
  ...
  head() {
    return {
      title: "Pilih Visa Umrah - Buat Paket Umrah | Haloatta"
    };
  },
  data() {
    return {
  ...
  methods: {
    nextSteps() {
      this.$router.push("/create/steps/insurance");
    }
  },
  components: {
    siderSteps
