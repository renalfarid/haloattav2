<template>
  <a-layout class="ant-layout--payment" :style="{ maxWidth: '1200px', margin: '0 auto' }">
    ...
    <a-layout :style="{ marginLeft: '280px', padding: '24px' }">
      <a-layout-content class="ant-layout-content--payment-ePackage ant-layout-content--payment-ePackage-failed" :style="{ paddingTop: '0' }">
        <e-package-failed />
      </a-layout-content>
    </a-layout>
  </a-layout>
...
import ePackageFailed from "~/components/contents/e-package/failed/index.vue"
export default {
  layout: "application",
  name: "epackage",
  head() {
