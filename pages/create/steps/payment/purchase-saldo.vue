  ...
  <a-layout class="ant-layout--payment" :style="{ maxWidth: '1200px', margin: '0 auto' }">
    ...
    <a-layout :style="{ marginLeft: '280px', padding: '24px' }">
      <a-layout-content class="ant-layout-content--payment-purchase" :style="{ paddingTop: '0' }">
        <a-list itemLayout="horizontal" class="ant-list--package-information" :style="{ marginTop: '-16px' }">
                    ...
                    <a-row :gutter="16" type="flex" justify="space-around" align="bottom">
                      <a-col :span="16">
                        <a-form-item label="Jumlah Saldo Anda">
                          <a-input addonBefore="Rp." size="large" value="590.000.000" disabled></a-input>
                        </a-form-item>
                      </a-col>
                      <a-col :span="8">
                        <a-form-item>
                          <a-button class="ant-btn--action-outline" size="large" block>Top Up Saldo</a-button>
                        </a-form-item>
                      </a-col>
                    </a-row>
                  </a-form>
                        ...
                        <a-row type="flex" justify="space-around" align="middle">
                          <a-col :span="14">
                            ...
                            <a-form-item label="Total Bayar">
                              <a-input addonBefore="Rp." size="large" value="930.000.731" disabled></a-input>
                            </a-form-item>
                      ...
                      <a-form layout="vertical" hideRequiredMark>
                        <a-row type="flex" justify="space-around" align="middle">
                          <a-col :span="14">
                            ...
                            <a-form-item label="Total Bayar">
                              <a-input addonBefore="Rp." size="large" value="500.000.731" disabled></a-input>
                            </a-form-item>
...
export default {
  ...
  head() {
    return {
      title: "Pembayaran Saldo Halopay - Buat Paket Umrah | Haloatta"
    };
  },
  data() {
    return {
  ...
  methods: {
    ...
    nextEpackagePaidOff() {
      this.$router.push("/create/steps/payment/e-package-paid-off");
    },
    nextEpackageFailed() {
      this.$router.push("/create/steps/payment/e-package-failed");
    }
  },
  components: {
    siderSteps
