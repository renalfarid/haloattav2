<template>
  <a-layout class="ant-layout--payment" :style="{ maxWidth: '1200px', margin: '0 auto' }">
    ...
    <a-layout :style="{ marginLeft: '280px', padding: '24px' }">
      <a-layout-content class="ant-layout-content--payment-ePackage ant-layout-content--payment-ePackage-paidoff" :style="{ paddingTop: '0' }">
        <e-package-paid-off />
      </a-layout-content>
    </a-layout>
  </a-layout>
...
import ePackagePaidOff from "~/components/contents/e-package/paid-off/index.vue"
export default {
  layout: "application",
  name: "epackage",
  head() {
    return {
      title: "e-paket - Buat Paket Umrah | Haloatta"
    };
  },
  data() {
    return {
