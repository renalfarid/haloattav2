            ...
            <div v-else>
              ...
              <a-form class="ant-form-modal--login" :form="form">
                <a-form-item>
                  <a-input
                    v-model="username"
                    v-decorator="['username',{ valuePropName: 'username', rules: [{ required: true, message: 'Harus di isi!' }] }]"
                ...
                <a-form-item>
                  <a-input
                    v-model="password"
                    v-decorator="['password',{ valuePropName: 'password', rules: [{ required: true, message: 'Harus di isi' }] }]"
