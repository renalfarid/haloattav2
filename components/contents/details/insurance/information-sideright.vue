<template>
  <div class="ant-affix--card">
    <a-card class="ant-card--package-information">
      ...
      <div class="p-16">
        <div
          class="ant-package--name fs-18 fw-500 cr-black"
        >Asuransi Perjalanan Umrah September 2020</div>
      </div>
      ...
      <div class="p-16">
        <div class="d-flex align-items-center">
          <div>
            ...
            <div class="ant-package--title fs-13 fw-500 cr-gray">Rp500.000 /Pax</div>
          </div>
          <div class="ml-auto">
            <number-input
              v-model="qty"
...
export default {
  ...
  methods: {
    nextOrderReview() {
      this.$router.push({ path: "/catalog/insurance/order-review" });
    }
  }
};
</script>