              ...
              <a-card class="ant-card-package" hoverable>
                <template slot="cover">
                  <flickity
                    ...
                    :options="ItemSlider"
                  >
                    <div v-for="(hotel, index) in latest.gambar_hotel" :key="index"
                      class="item-images"
                ...
                <nuxt-link
                  :to="'/catalog/umrah/detail-package?kode_produk=' + latest.kode_produk"
                ...
                >
                  <a-card-meta>
                    ...
                    <div slot="description">
                      <span class="cr-black-opacity">Kota {{ latest.nama_kota }}</span>
                  ...
                  <div class="md-card--bottom">
                    <div class="md-price">{{ latest.harga_jual | currency }}</div>
                    <div>
                      <a-icon
                        type="star"
                        theme="filled"
