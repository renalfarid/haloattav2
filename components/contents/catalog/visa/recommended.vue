      ...
      >
        <a-card class="ant-card-package-small">
            ...
            >
              <div class="d-none ant-card-cover--overlay">
                ...
                <div class="ant-card-cover--overlay-text">
                  ...
                  <div
                    class="ant-card-cover--overlay-text-subtitle text-uppercase fs-12"
                  >
                    pax
                  </div>
                </div>
              ...
              <div class="ant-card--overlay-block">
                <div class="d-flex align-items-center h-100">
                  <a-button>
                    <nuxt-link
                      :to="
                        '/catalog/visa/detail?kode_produk=' + item.kode_produk
                      "
          ...
          <a-card-meta>
            <div slot="title">
              <div
                class="ant-card-meta-title--top d-flex align-items-center mb-8"
              >
                <div
              ...
              <div class="ant-card-meta-title--package fw-500 fs-15">
                {{ item.nama }}
              </div>
            </div>
              ...
              >
                <div class="ant-card-meta-description--bottom-right d-flex">
                  <div class="fs-14 fw-400 cr-black f-default text-ellipsis">
                    Program {{ item.duration_stay }} Hari
                  </div>
                </div>
                <div
...
export default {
  ...
  methods: {
    async getdata() {
      axios.get(process.env.baseUrl + "visa/all").then(response => {
