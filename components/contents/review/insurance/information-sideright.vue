<template>
  <div class="ant-affix--card mt-24">
    <a-card class="ant-card--package-review">
      ...
      <div class="p-16">
        <div class="ant-package--name fs-18 fw-500 cr-black">Asuransi Perjalanan Umrah September 2020</div>
      </div>
      ...
      <div class="p-16">
        <div class="d-flex align-items-center mb-8">
          <div class="fs-14 fw-400 cr-black f-default">Jumlah (4) Pax</div>
          <div class="fs-14 fw-400 cr-black f-default ml-auto">
            <span class="cr-gray mr-8">x</span> Rp500.000
          </div>
        </div>
      </div>
