<template>
  <section>
    <a-card class="b-shadow b-solid bordered-left mb-16 mt-24" id="informasi">
    ...
    >
      ...
      <a-row :gutter="8">
        <a-col :span="6" v-for="(getFasiltas,i) in fasilitas" :key="i">
          <div class="d-flex align-items-start">
            <a-avatar
              style="backgroundColor: rgba(15, 172, 243, .1);color:#0FACF3"
              class="mr-8"
            ...
            />
            <div>
              <div class="fs-15 fw-500 cr-black">{{getFasiltas}}</div>
            </div>
          </div>
        </a-col>
      </a-row>
