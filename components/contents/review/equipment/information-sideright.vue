    ...
    <a-card class="ant-card--package-review">
      <div class="p-16">
        <div class="d-flex align-items-center">
          <div class="mr-8">
            <div class="ant-package--name fs-15 fw-500 cr-black">Subur Jaya</div>
          </div>
          <div class="ml-auto">
      ...
      <div class="p-16">
        <div class="d-flex align-items-center">
          ...
          <div class="ant-package--subtitle ml-auto fs-15 fw-500 cr-black f-default">Rp28.000.000</div>
        </div>
