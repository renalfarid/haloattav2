    ...
    <a-card class="ant-card--package-review">
      <div class="p-16">
        <div class="d-flex align-items-center">
          <div class="mr-8">
            <div class="ant-package--name fs-15 fw-500 cr-black">Go Bro Event</div>
          </div>
          <div class="ml-auto">
      ...
      <div class="p-16">
        <div class="d-flex align-items-center">
          ...
          <div class="ant-package--subtitle ml-auto fs-15 fw-500 cr-black f-default">Rp4.000.000</div>
        </div>
