    ...
    <a-card class="ant-card--package-review">
      <div class="p-16">
        ...
        <div class="d-flex align-items-center">
          ...
          <div>
            <div class="ant-package--name fs-15 fw-500 cr-black">Babul Tour</div>
          </div>
        </div>
      </div>
      ...
      <div class="p-16">
        <div class="ant-package--name fs-18 fw-500 cr-black">Garda Group Tour Leader Umrah</div>
      </div>
      ...
      <div class="p-16">
        ...
        <div class="ant-package--subtitle fs-22 fw-500 cr-black d-block f-default">Rp 2.000.000</div>
