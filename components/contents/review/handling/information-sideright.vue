    ...
    <a-card class="ant-card--package-review">
      <div class="p-16">
        <div class="d-flex align-items-center">
          <div class="mr-8">
            <div class="ant-package--name fs-15 fw-500 cr-black">Hasanuddin Handling</div>
          </div>
          <div class="ml-auto">
      ...
      <div class="p-16">
        ...
        <div class="d-flex align-items-center">
          <div class="ant-package--info fs-14 fw-400 cr-gray">Keberangkatan</div>
          <div class="ant-package--info fs-14 fw-400 cr-black ml-auto">10 September 2019</div>
        </div>
        <div class="d-flex align-items-center">
          <div class="ant-package--info fs-14 fw-400 cr-gray">Kedatangan</div>
          <div class="ant-package--info fs-14 fw-400 cr-black ml-auto">19 September 2019</div>
        </div>
      </div>
      <a-divider :style="{margin: '0'}" />
      <div class="p-16">
        <div class="fs-15 fw-500 cr-black mb-8">Jumlah Pax</div>
        <div class="d-flex align-items-center mb-8">
          <div class="fs-14 fw-400 cr-gray f-default">Dewasa (4)</div>
          <div class="fs-14 fw-400 cr-black f-default ml-auto">
            <span class="cr-gray mr-8">x</span> Rp 100.000
          </div>
        </div>
        <div class="d-flex align-items-center mb-8">
          <div class="fs-14 fw-400 cr-gray f-default">Anak (0)</div>
          <div class="fs-14 fw-400 cr-black f-default ml-auto">
            <span class="cr-gray mr-8">x</span> Rp 100.000
          </div>
        </div>
      ...
      <div class="p-16">
        <div class="d-flex align-items-center">
          ...
          <div class="ant-package--subtitle ml-auto fs-15 fw-500 cr-black f-default">Rp400.000</div>
        </div>
