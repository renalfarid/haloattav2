<template>
  <a-list itemLayout="horizontal" class="ant-list--package-information">
    <a-list-item class="ant-list-item--package-information">
      <div>
        <h2 class="ant-package--information-title fs-20 cr-black fw-500">Ulasan Pesanan Handling Domestik</h2>
    ...
    <a-list-item class="ant-list-item--package-information">
      <div class="w-100">
        <div class="d-flex align-items-center w-100">
          ...
          <div>
            <div class="fs-14 fw-400 cr-gray f-default">Penyedia Handling</div>
            <div class="fs-16 fw-500 cr-black">Hasanuddin Handling</div>
          </div>
        </div>
