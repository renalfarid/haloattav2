...
.vue-otp-field::-webkit-inner-spin-button,
.vue-otp-field::-webkit-outer-spin-button {
  -moz-appearance: textfield;
  -webkit-appearance: none;
  margin: 0;
}
.vue-otp-field:active,
.vue-otp-field:focus {
  outline: 0;
  box-shadow: none;
